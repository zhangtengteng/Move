...
import com.xuanit.move.adapter.AlbumGridViewAdapter;
import com.xuanit.move.util.AlbumHelper;
import com.xuanit.move.util.Bimp;
import com.xuanit.move.util.ImageBucket;
...
public class AlbumActivity extends Activity {
	...
	private class AlbumSendListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(mContext, PhotoAddActivity.class);
			startActivity(intent);
			finish();
		}
